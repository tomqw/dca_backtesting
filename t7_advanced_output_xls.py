...
for config in config_list:
    if config.config_name in whitelist or whitelist == []:
        ...
        total_bot_profit_percent = round(
            100 / (config.max_amount_for_bot_usage * len(pairs)) * total_bot_profit, 4
        )

        bot_current_profit_percent = round(
            100 / bot_total_volume * bot_current_profit, 4
        )
        ...
        total = {
            ...
            "profit": total_bot_profit,
            "profit_percent": total_bot_profit_percent,
            ...
            "max_amount_for_bot_usage": max_amount_for_bot_usage,
